...
class gated_pixel_cnn():
    ...
    def gated_layer(self, wsize, p, channel, layer):
        ...
        self.tmp = tf.nn.relu(tf.nn.conv2d(self.vertical_stack, weightv11, strides=[1,1,1,1], padding='SAME'))
        ...
        self.horizontal_stack = tf.nn.relu(tf.nn.conv2d(self.horizontal_stack, weighth11, strides=[1,1,1,1], padding='SAME'))
